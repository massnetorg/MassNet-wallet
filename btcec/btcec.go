...
func fromHex(s string) *big.Int {
	...
	if !ok {
		logging.CPrint(logging.FATAL, "invalid hex in source file", logging.LogFormat{"s": s})
	}
	return r
}
...
func initS256() {
	...
	if err := loadS256BytePoints(); err != nil {
		logging.CPrint(logging.FATAL, "err in loadS256BytePoints", logging.LogFormat{"err": err})
	}
