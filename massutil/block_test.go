...
//	b := massutil.NewBlock(&Block100000)
//
...
//	wantHash, err := wire.NewHashFromStr(wantHashStr)
//	if err != nil {
...
//		wantHash, err := wire.NewHashFromStr(txHash)
//		if err != nil {
//			t.Errorf("NewHashFromStr: %v", err)
//		}
//
...
//			wantHash, err := wire.NewHashFromStr(wantTxHashes[j])
//			if err != nil {
//				t.Errorf("NewHashFromStr: %v", err)
//			}
//
...
//	err = Block100000.Serialize(&block100000Buf, wire.DB)
//	if err != nil {
...
//	// caching.
//	for i := 0; i < 2; i++ {
//		serializedBytes, err := b.Bytes(wire.DB)
//		if err != nil {
...
//	b, err := massutil.NewBlockFromBytes(block100000Bytes, wire.DB)
//	if err != nil {
...
//
//	// Create a new block from the serialized bytes.
//	b := massutil.NewBlockFromBlockAndBytes(&Block100000, block100000Bytes, wire.DB)
//
//	// Ensure we get the same data back out.
//	serializedBytes, err := b.Bytes(wire.DB)
//	if err != nil {
...
//	testErr := massutil.OutOfRangeError(wantErr)
...
//	_, err = massutil.NewBlockFromBytes(shortBytes, wire.DB)
//	if err != io.EOF {
...
//	_, err = b.TxHash(-1)
//	if _, ok := err.(massutil.OutOfRangeError); !ok {
//		t.Errorf("TxHash: wrong error - got: %v <%T>, "+
//			"want: <%T>", err, err, massutil.OutOfRangeError(""))
//	}
