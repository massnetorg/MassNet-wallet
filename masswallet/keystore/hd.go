...
var (
	ErrInvalidCoinType      = errors.New("coin type may not exceed " + strconv.FormatUint(maxCoinType, 10))
	ErrInvalidAccountNumber = errors.New("account number may not exceed " + strconv.FormatUint(MaxAccountNum, 10))
)
