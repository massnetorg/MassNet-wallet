...
type Tx struct {
	...
	txHash        *wire.ShaHash // Cached transaction hash
	txHashWitness *wire.ShaHash // Cached transaction witness hash
...
func (t *Tx) WitnessHash() *wire.ShaHash {
	// Return the cached hash if it has already been generated.
